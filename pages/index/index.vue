<template>
		...
		<image src="/static/image/ShangShou_Index.png" style="width: 100%; margin-top: -50rpx;"></image>	
			...
			<tm-sheet :shadow="24" style="margin-top: -100rpx; position: relative;z-index: 10;height: 270rpx;"  bgColor="#2F7E79">
				...
				<tm-row style="margin-top: 35rpx;">
					...
					<tm-col :grid="6"  justify="right">
						...
						<text style="font-size: 15px;color: #fff;font-family: YouYuan;"  @click="changePage(3)">贷  款</text><br/>
						<text style="font-size: 18px;color: #fff;font-family: YouYuan;"  @click="changePage(3)">￥{{sum.loan}}</text>
					</tm-col>
			...
			<view v-if="show_page===1" style="height: 400rpx;  position: relative;z-index: 10;" >
				<tm-row>
					<tm-col :grid="6" justify="left">
						<text style="font-size: 16px;font-weight: 600;margin-left: 25rpx;">收支情况</text>
						<text style="font-size: 16px;font-weight: 600;margin-left: 25rpx;">{{$store.state.token}}</text>
					</tm-col>
				...
				<view style=" margin-left: 18px;margin-right: 22px;margin-top: 10px;">
					<view>
						...
						<tm-row>
							...
							<tm-col :grid="9" justify="left"  style="margin-top: 10rpx;">
								<text style="font-size: 16px;">{{item.outcomeName}}</text>
							</tm-col>
							<tm-col :grid="1" justify="right"  style="margin-top: 10rpx;">
								<text  style= "font-size: 16px;color: crimson;">￥{{item.outcome}}</text>
							</tm-col>
						</tm-row>
						</tm-switchList>
